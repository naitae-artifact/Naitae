...
protected:
 ...
 public:
  ...
  bool is_instance_klass()              const { return assert_same_query(_kind <= InstanceIndexingTreeKlassKind, is_instance_klass_slow()); }
  ...
  bool is_objArray_klass()              const { return assert_same_query( _kind == ObjArrayKlassKind || _kind == WeakObjArrayKlassKind, is_objArray_klass_slow()); }
