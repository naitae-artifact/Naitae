...
// Interface to java.lang.rv.IndexingTree objects

class java_lang_rv_IndexingTree: AllStatic {
  static int _size_offset;
  static int _id_offset;
  static int _upThreshold_offset;
  static int _downThreshold_offset;
  static int _table_offset;
  static int _capacity_offset;

 public:
  static inline int size_value(oop obj);
  static inline void set_size(oop obj, int value);
  static inline int capacity_value(oop obj);
  static inline objArrayOop table(oop obj);
  static inline void set_table(oop obj, objArrayOop value);
  static inline void set_capacity(oop obj, int v);
  static inline void set_upThreshold(oop obj, int v);
  static inline void set_downThreshold(oop obj, int v);

  static int table_offset()         { CHECK_INIT(_table_offset); }
  static int size_offset()          { CHECK_INIT(_size_offset); }

  static void compute_offsets();
  static void serialize_offsets(SerializeClosure* f) NOT_CDS_RETURN;
};

// Interface to java.lang.rv.IndexingTreeEntry objects

class java_lang_rv_IndexingTreeEntry: AllStatic {
  static int _hashCode_offset;
  static int _keys_offset;
  static int _value_offset;
  static int _next_offset;

 public:
  static inline int entry_hashCode(oop obj);
  static inline objArrayOop keys(oop obj);
  static inline void set_keys(oop obj, objArrayOop v);
  static inline oop value(oop obj);
  static inline void set_value(oop obj, oop v);
  static inline oop next(oop obj);
  static inline void set_next(oop obj, oop v);

  static int keys_offset()          { CHECK_INIT(_keys_offset); }
  static int value_offset()         { CHECK_INIT(_value_offset); }
  static int next_offset()          { CHECK_INIT(_next_offset); }
