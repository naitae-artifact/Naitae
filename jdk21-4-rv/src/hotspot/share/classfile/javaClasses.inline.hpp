...
// java.lang.rv.IndexingTree accessors

inline int java_lang_rv_IndexingTree::size_value(oop obj) {
  return obj->int_field(_size_offset);
}

inline void java_lang_rv_IndexingTree::set_size(oop obj, int value) {
  obj->int_field_put(_size_offset, value);
}

inline int java_lang_rv_IndexingTree::capacity_value(oop obj) {
  return obj->int_field(_capacity_offset);
}

inline objArrayOop java_lang_rv_IndexingTree::table(oop obj) {
  return objArrayOop(obj->obj_field(_table_offset));
}

inline void java_lang_rv_IndexingTree::set_table(oop obj, objArrayOop value) {
  obj->obj_field_put(_table_offset, value);
}

inline void java_lang_rv_IndexingTree::set_capacity(oop obj, int v) {
  obj->int_field_put(_capacity_offset, v);
}

inline void java_lang_rv_IndexingTree::set_upThreshold(oop obj, int v) {
  obj->int_field_put(_upThreshold_offset, v);
}

inline void java_lang_rv_IndexingTree::set_downThreshold(oop obj, int v) {
  obj->int_field_put(_downThreshold_offset, v);
}

// java.lang.rv.IndexingTreeEntry accessors

inline int java_lang_rv_IndexingTreeEntry::entry_hashCode(oop obj) {
  return obj->int_field(_hashCode_offset);
}

inline objArrayOop java_lang_rv_IndexingTreeEntry::keys(oop obj) {
  return objArrayOop(obj->obj_field(_keys_offset));
}

inline void java_lang_rv_IndexingTreeEntry::set_keys(oop obj, objArrayOop v) {
  obj->obj_field_put(_keys_offset, v);
}

inline oop java_lang_rv_IndexingTreeEntry::value(oop obj) {
  return obj->obj_field(_value_offset);
}

inline void java_lang_rv_IndexingTreeEntry::set_value(oop obj, oop v) {
  obj->obj_field_put(_value_offset, v);
}

inline oop java_lang_rv_IndexingTreeEntry::next(oop obj) {
  return obj->obj_field(_next_offset);
}

inline void java_lang_rv_IndexingTreeEntry::set_next(oop obj, oop v) {
  obj->obj_field_put(_next_offset, v);
}
