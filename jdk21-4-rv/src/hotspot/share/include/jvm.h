...
JVM_IndexingTreeInit(JNIEnv *env, jobject tree, jint capacity);

JNIEXPORT jobjectArray JNICALL
JVM_IndexingTreeAllocTable(JNIEnv *env, jclass cls, jint capacity);

JNIEXPORT void JNICALL
JVM_IndexingTreeAdjustCapacity(JNIEnv *env, jobject tree,
                               jint new_capacity,
                               jint new_up_threshold,
                               jint new_down_threshold);

/*
 * java.lang.rv.WeakObjArray
 */
JNIEXPORT jobjectArray JNICALL
JVM_WeakObjArrayAllocate(JNIEnv *env, jclass cls, jint length);
