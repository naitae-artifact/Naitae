...
void ShenandoahConcurrentGC::op_final_mark() {
  ...
  if (!heap->cancelled_gc()) {
    ...
    // TODO: IndexingTree cleanup for Shenandoah.  Initial attempt
    // crashed during multi-iteration runs (e.g., DaCapo n=10 xalan).
    // Likely cause: SATB barrier requirements when modifying entries
    // post-marking, or marking context state.  Needs investigation.
