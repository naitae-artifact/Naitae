...
bool ZGenerationOld::mark_end() {
  ...
  // TODO: IndexingTree cleanup for ZGC.  Needs proper integration
  // with ZGC's colored pointer / load barrier system.  Direct field
  // reads via raw access don't apply ZGC's load barriers.
