...
void G1ConcurrentMark::mark_from_roots() {
  ...
  // Entered before concurrent mark workers scan the heap so they skip
  // the IndexingTree table field via should_skip_table().
  // Left in weak_refs_work() after cleanup.
...
void G1ConcurrentMark::weak_refs_work() {
  ...
  // WeakArrayScanScope::StrongMark was entered in mark_from_roots() before
  // concurrent workers started.  It is still active here at remark.
